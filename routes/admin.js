...
} = require("../controller/docsRequiredController");
...
var upload = multer({ storage: storage }, { encoding: "utf8" });
...
router.post(
  "/addschoolname",
  upload.fields([{ name: "schoolLogo" }, { name: "countryLogo" }]),
  addSchoolname
);
router.post(
  "/updateschoolname",
...
router.post("/getSingleProgram", getSingleProgram);
...
router.post("/getSingleProgramDetail", getSingleProgramDetail); // why
router.post("/getSingleSchoolDetails", getSingleSchoolDetails); // why
